...
- Started project from [Material Tailwind Kit React](https://www.creative-tim.com/product/tpcp-admnistradora?ref=changelog-mtkr)
- Updated all dependencies from [Material Tailwind Kit React](https://www.creative-tim.com/product/tpcp-admnistradora?ref=changelog-mtkr) and those dependencies that were not working with the new React v17+ API, were deleted and/or replaced
